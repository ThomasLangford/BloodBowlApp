...
namespace BloodBowlAPI.Controllers.Skills
{
    ...
    public class SkillCategoriesController : ControllerBase
    {
        ...
        private IQueryable<SkillCategory> GetSkillCatagoryQueryable(BloodBowlData.Enums.SkillCategory id)
        {
        ...
        {
            if (!Enum.IsDefined(typeof(BloodBowlData.Enums.SkillCategory), id))
            {
                return null;
            }

            var enumId = (BloodBowlData.Enums.SkillCategory)id;
